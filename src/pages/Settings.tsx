...
const Settings = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      adminOnly: true,
      items: [
        { id: 'comissoes', label: 'Regras de Comissão' },
        { id: 'config-loja', label: 'Configurações da Loja' },
        { id: 'status', label: 'Status de Orçamento' }
      ]
    },
    {
      id: 'operacional',
      ...
      items: [
        { id: 'montadores', label: 'Montadores' },
      ...
      <div className="container mx-auto p-6">
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <Badge variant="secondary">{userProfile}</Badge>
          </div>
          <p className="text-muted-foreground">
            Sistema de Validação - Fluyt
          </p>
        </div>
